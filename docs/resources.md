...
<div class="resources-grid">
    ...
    <a href="assets/research_paper.pdf" class="resource-card">
        ...
        <div class="resource-name">Turkish integration in Germany</div>
    </a>
    <a href="assets/reflective_analysis.pdf" class="resource-card">
        <div class="resource-preview">
            <img src="assets/pdf.svg" alt="Reflection on “The Paranoid Style in American Politics” by Richard Hofstadter">
        </div>
        <div class="resource-name">Reflection on “The Paranoid Style in American Politics” by Richard Hofstadter</div>
    </a>
    <a href="assets/reflective_analysis_2.pdf" class="resource-card">
        <div class="resource-preview">
            <img src="assets/pdf.svg" alt="Reflection on communicating with distant audiences and evoking action">
        </div>
