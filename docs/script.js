...
class MarkdownLoader {
    constructor() {
        this.sections = ['about', 'publications', 'resources', 'photography', 'resume'];
        this.init();
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    console.log('Built from astro-theme-cactus');
});
...
class GalleryModal {
    ...
    createModal() {
        ...
        this.modal.innerHTML = `
            ...
            <img class="gallery-modal-content" alt="">
            <div class="gallery-modal-caption"></div>
        `;

        document.body.appendChild(this.modal);

        this.modalImg = this.modal.querySelector('.gallery-modal-content');
        this.caption = this.modal.querySelector('.gallery-modal-caption');
    ...
    openModal(img) {
        ...
        this.caption.textContent = img.alt || 'Gallery Image';
