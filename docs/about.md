<div class="about-header">
  <img src="assets/profile.jpg" alt="Avatar" class="about-avatar" width="160" height="160" loading="lazy" />
  ...
  <a href="https://github.com/oafischer" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://www.linkedin.com/in/oliveralbertfischer/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="mailto:oafischer@proton.me" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I'm a technical communicator with a background in journalism.

I currently work as a technical writer at Red Hat where I write, edit, and maintain documentation for Red Hat Advanced Cluster Management for Kubernetes.

I'm a volunteer on the ACM SIGDOC Structured Authoring Steering Committee and a member of the OASIS DITA Technical Committee.

In my free time, I enjoy street and travel photography, wrenching on cars, and tinkering with mechanical keyboards or PC builds.
